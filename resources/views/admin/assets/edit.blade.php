    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form class="form-horizontal" method="post" action="{{ route('admin.assets.update', $asset->id) }}" name="edit_asset" id="edit_asset" novalidate="novalidate">
                            @method('PATCH')
                            {{ csrf_field() }}
                            <!-- /.card-header -->
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control" name="serial" id="serial" required="" value="{{$asset->serial}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            <label class="control-label">Ngày mua</label>
                                              <div class="input-group date" id="purchasing_date" data-target-input="nearest">
                                                  <input type="text" id="purchasing_date" name="purchasing_date" class="form-control datetimepicker-input" data-target="#purchasing_date" value="{{null != $asset->purchasing_date ? (new \DateTime($asset->purchasing_date))->format('d-m-Y') : ''}}"/>
